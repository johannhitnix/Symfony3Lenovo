...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`Categories` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `sakila`.`Entries`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`Entries` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_Entries_Users1_idx` (`user_id` ASC),
  ...
  CONSTRAINT `fk_Entries_Categories1`
    FOREIGN KEY (`category_id`)
    REFERENCES `sakila`.`Categories` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `sakila`.`Tags`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`Tags` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NULL,
  `description` TEXT NULL,
  PRIMARY KEY (`id`))
...
-- -----------------------------------------------------
-- Table `sakila`.`Entry_Tag`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sakila`.`Entry_Tag` (
  `id` VARCHAR(45) NOT NULL,
  `entry_id` INT NOT NULL,
  `tag_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_Entries_has_Tags_Tags1_idx` (`tag_id` ASC),
  INDEX `fk_Entries_has_Tags_Entries1_idx` (`entry_id` ASC),
  CONSTRAINT `fk_Entries_has_Tags_Entries1`
    FOREIGN KEY (`entry_id`)
    REFERENCES `sakila`.`Entries` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Entries_has_Tags_Tags1`
    FOREIGN KEY (`tag_id`)
    REFERENCES `sakila`.`Tags` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
